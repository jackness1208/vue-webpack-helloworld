(function($, window, document, undefined) {
    ...
    $.fn.lazyload = function(options) {
        ...
        this.each(function() {
            ...
            self.loaded = false;
            ($self.attr("src") === undefined || !1 === $self.attr("src") || '' === $self.attr("src")) && $self.is("img") && $self.attr("src", settings.placeholder);
        ...
        /* Force initial check immediately if images should appear. */
        if(settings.isForceCheck){
            update();
        }
